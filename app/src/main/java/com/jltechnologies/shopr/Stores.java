...
//producs, prices, and location are parrelel arrays and must be the same length at each store. Location name array string corresponds to the location number
    ...
    public String[]   locationName2 = {"The Left Entrance", "The Cashier", "The Right Entrance", "The Pharmacy", "Aisle 1", "Aisle 2", "Aisle 3", "The Bakery", "Aisle 4", "Aisle 5", "Aisle 6" };
    ...
    public String[]   locationName3 = {"The Left Entrance", "The Cashier", "The Right Entrance", "The Pharmacy", "Aisle 1", "Aisle 2", "Aisle 3", "The Bakery", "Aisle 4", "Aisle 5", "Aisle 6" };
    ...
    public String[]   locationName4 = {"The Left Entrance", "The Cashier", "The Right Entrance", "The Pharmacy", "Aisle 1", "Aisle 2", "Aisle 3", "The Bakery", "Aisle 4", "Aisle 5", "Aisle 6" };
    ...
    public String[]   locationName6 = {"The Left Entrance", "The Cashier", "The Right Entrance", "Produce", "Fresh Meat", "The Pharmacy", "The Bakery", "The Deli", "Aisle 1", "Aisle 2", "Aisle 3", "Aisle 4", "Aisle 5", "Aisle 6"};
